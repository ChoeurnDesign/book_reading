                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('books.removeFromFavorites', $book->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to remove this book from your favorites?');" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
